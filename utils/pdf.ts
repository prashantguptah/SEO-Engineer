...
<head>
  <meta charset="UTF-8" />
  <title>keywordwalks — ${escapeHtml(report.title)}</title>
  <style>
    :root {
      --ink: #0a1214;
      --muted: #5a787c;
    ...
    * { box-sizing: border-box; }
    ...
    .brand-bar {
      ...
      background: linear-gradient(135deg, #001014 0%, #006870 45%, #00c5d4 78%, #7cff6b 100%);
...
<body>
  <div class="page">
    <header class="brand-bar">
      <div>
        <div class="brand-name">keywordwalks</div>
        <div class="brand-sub">Keywords · Research · SEO</div>
      </div>
    ...
    <footer class="footer">
      <span>Generated by keywordwalks</span>
